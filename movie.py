...
if sluzba in sluzby and sluzba == "dostupne filmy":
    print("Dostupne filmy: ".upper(), " , ".join(tuple(filmy.keys())))



elif sluzba in sluzby and sluzba == "detaily filmu":
    print("Dostupne filmy: ".upper(), " , ".join(tuple(filmy.keys())))
    film = input("Vyber film: ")
    print(filmy[film])

elif sluzba in sluzby and sluzba == "reziseri":
    vyber_reziseri = {film_1["REZISER"], film_2["REZISER"], film_3["REZISER"], film_4["REZISER"]}
    print(", ".join(vyber_reziseri))

else:
    print("sluzba neni k dispozici")
    quit()